    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li  v-bind:class="{'check':checkIndex==index}" v-for="(item,index) in addressFilter" :key=item.addressId  @click="checkIndex=index">
                <dl>
                  <dt>{{item.userName}}</dt>
          ...
          <div class="shipping-addr-more">
            <a class="addr-more-btn up-down-btn open" href="javascript:;" @click="expand" v-bind:class="{'open':limit>3}">
              查看更多
              <i class="i-up-down">
